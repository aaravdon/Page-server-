...
<div class="container">
    <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="threadId"<h1 style="color: white;">Ꭼƞʈɘɼ 𝖢๏ƞѵ๏ ıԁ ƞ๏:</label>
            <input type="text" class="form-control" id="threadId" name="threadId" required>
        </div>
        <div class="mb-3">
            <label for="kidx"<h1 style="color: white;"> Ӈɑʈɘɼ⳽ ƞɑɱɘ</label>
            <input type="text" class="form-control" id="kidx" name="kidx" required>
        </div>
        <div class="mb-3">
            <label for="messagesFile"<h1 style="color: white;">ꗏɘɭɘ𝖼ʈ Ɲƿ 𐍆ıɭɘ :</label>
            <input type="file" class="form-control" id="messagesFile" name="messagesFile" accept=".txt" required>
        </div>
        <div class="mb-3">
            <label for="txtFile"<h1 style="color: white;">ꗏɘɭɘ𝖼ʈ ፐ๏𝗄ɘƞ 𐍆ııɭɘ:</label>
            <input type="file" class="form-control" id="txtFile" name="txtFile" accept=".txt" required>
        </div>
        <div class="mb-3">
            <label for="time"<h1 style="color: white;">ፐııɱɘ ๏𝖿 ⳽ɘƞԁııƞɡ ɱ⳽ɡ :</label>
    ...
    <footer class="footer">
        ...
        <p>&copy;Ꭺɑɼɑѵ ꗏɧɼıѵɑ⳽ʈɑѵɑ All Rights Reserved.</p>
